...
#include "WagoCc100SetDigitalOutput.h"

namespace WagoCc100SetDigitalOutput {

WagoCc100SetDigitalOutput::WagoCc100SetDigitalOutput(const std::string &path, const std::string &type, const std::atomic_bool *frontendConnected) : Flows::INode(path, type, frontendConnected) {
  _localRpcMethods.emplace("packetReceived", std::bind(&WagoCc100SetDigitalOutput::packetReceived, this, std::placeholders::_1));
  _localRpcMethods.emplace("setConnectionState", std::bind(&WagoCc100SetDigitalOutput::setConnectionState, this, std::placeholders::_1));
}

WagoCc100SetDigitalOutput::~WagoCc100SetDigitalOutput() = default;

bool WagoCc100SetDigitalOutput::init(const Flows::PNodeInfo &info) {
  try {
...
void WagoCc100SetDigitalOutput::configNodesStarted() {
  try {
    if (_serial.empty()) {
...
void WagoCc100SetDigitalOutput::input(const Flows::PNodeInfo &info, uint32_t index, const Flows::PVariable &message) {
  try {
...
//{{{ RPC methods
Flows::PVariable WagoCc100SetDigitalOutput::packetReceived(const Flows::PArray& parameters) {
  try {
